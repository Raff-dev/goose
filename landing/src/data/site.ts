...
export const site = {
  ...
  promptOrigin: {
    ...
    body:
      "The whole presentation collapses into the artifact itself: one prompt kicked off the research, structure, copy, and shipped page below. Typos are preserved on purpose.",
    ...
    code: [
      ...
      "problemy rozwiazuje to repozytorium. ta strona ma byc prezentacja moja",
      " ktora przedstawie na wystapieniu, wiec ma opowiadac historie dlaczego",
      " wlge to powstalo - robisz sobie apke agentowa i wszystko fajnie jak",
      "masz jednego toola, dwa, zmieniasz system prompt, przetestujesz sobie",
      "pogadasz z tym agentem widzisz ze dziala. ale wtedy dodajesz kolejne",
      "dwa toole, kolejne, masz 15 tooli, 20 tooli  i zaczyna sie spory",
      "problem. zmieniasz jedna rzecz, ktora affectuje potencjalnie calego",
      "agenta jak np system prompt i jest kurcze klopot. goose pozwala ci",
      "pisac expectations w jezyku naturalnym - czemu? bo llm moze odpowiadac",
      " roznymi sformulowaniami - nie sposob tego przetestowac",
      "deterministycznie sprawdzajac regex albo keywordy. no i tu pojawia sie",
      " goose caly na bialo - robisz expectations jezykiem naturalnym,",
      "wpisujesz jakie toole powinny sie wykonac. napiszesz raz test i za",
      "kazdym razem masz potwierdzone dzialanie - zero recznego testowania.",
      "goose jest toolsetem do robienia i testowania agentow - masz tam te",
      "test cases, mozezsz bezpossrednio wywolywac toole zeby je debugowac,",
      "masz ztam chatak tory pokazuje ci wszystko co dzieje sie pod spodem z",
      "jakimi argumentami agent wywoluje jakie toole, jakie outputy",
      "przychodza. przede wszystkim goose zrobiony byl zeby byl",
      "agent-friendly - masz outputy w plikach, twoj agent moze odpalac",
      "testy, patrzec jak wygladaly wyniki, amsz historie, regresje. bajka.",
