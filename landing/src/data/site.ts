...
export const site = {
  ...
  presentation: {
    chrome: {
      ...
      primaryCta: { label: "View on GitHub", href: REPO_URL, hidden: false },
    },
    opening: {
      step: "01",
    ...
    close: {
      ...
      primaryCta: { label: "Explore Goose on GitHub", href: REPO_URL, hidden: false },
      secondaryCta: { label: "Open issues", href: `${REPO_URL}/issues`, hidden: false },
  ...
  appendix: {
    ...
    secondaryCtas: [
      { label: "View on GitHub", href: REPO_URL, hidden: false },
  ...
  hero: {
    ...
    primaryCta: { label: "Explore the repo", href: REPO_URL, hidden: false },
    secondaryCtas: [
      { label: "Install from PyPI", href: PYPI_URL },
      { label: "npm dashboard", href: NPM_URL },
      { label: "Read the docs", href: README_URL, hidden: false },
    ],
    stats: [
  ...
  finalCta: {
    ...
    secondaryCtas: [
      { label: "Install from PyPI", href: PYPI_URL },
      { label: "Open the README", href: README_URL, hidden: false },
    ],
  },
  promptOrigin: {
