...
class GooseApp:
    ...
    def __init__(
        ...
        """
        self.tools: list[Callable] = tools if tools is not None else []
    ...
    def __repr__(self) -> str:
        return f"GooseApp(tools={len(self.tools)}, reload_targets={self.reload_targets}, reload_exclude={self.reload_exclude})"
